        ...
        <div className="absolute right-0 top-0 w-[80%] h-full opacity-50">
          <svg className="absolute inset-0 w-full h-full" viewBox="0 0 800 800" xmlns="http://www.w3.org/2000/svg">
            <g className="animate-[spin_40s_linear_infinite]" transform-origin="400 400">
              <circle cx="600" cy="200" r="150" fill="#a7f3d0" className="animate-[pulse_4s_ease-in-out_infinite]" />
              <circle cx="200" cy="600" r="200" fill="#d1fae5" className="animate-[pulse_5s_ease-in-out_infinite_0.5s]" />
              <circle cx="700" cy="600" r="100" fill="#6ee7b7" className="animate-[pulse_3s_ease-in-out_infinite_1s]" />
            </g>
            <g className="animate-[bounce_8s_ease-in-out_infinite]" transform-origin="400 400">
              <path d="M400,100 Q450,50 500,100 T600,100" stroke="#34d399" strokeWidth="8" fill="none" strokeLinecap="round" opacity="0.5" />
              <path d="M200,300 Q250,250 300,300 T400,300" stroke="#34d399" strokeWidth="8" fill="none" strokeLinecap="round" opacity="0.3" />
            </g>
          </svg>
